    ...
    return (
        <div className={cn(blocks.content_block, styles.page)}>
            ...
            <div className={cn(styles.data, styles.active)}>
                <p className={styles.show_more_btn}>
                    <span className={styles.show_more_icn} />
                    Как вернуть не подошедший товар?
                </p>
            ...
            <div className={cn(styles.data, styles.active)}>
                <p className={styles.show_more_btn}>
                    <span className={styles.show_more_icn} />
                    Как и когда произойдет возврат средств?
                </p>
            ...
            <div className={cn(styles.data, styles.active)}>
                <p className={styles.show_more_btn}>
                    <span className={styles.show_more_icn} />
                    За чей счёт осуществляется обратная отправка товара?
                </p>
            ...
            <div className={cn(styles.data, styles.active)}>
                <p className={styles.show_more_btn}>
                    <span className={styles.show_more_icn} />
                    Чем регулируется возврат товара?
                </p>
