        ...
        <div className={blocks.content_body}>
            <div className={cn(blocks.content_block, styles.page)}>
                <div className={styles.row}>
                    ...
                    <img src="/images/blocks/150.jpg" alt="" className={styles.desktop}/>
                ...
                <div className={styles.row}>
                    ...
                    <div className={styles.data_wrapper}>
                        ...
                        <p className={styles.data}>Телефон: <a href="tel:+7 (929) 500-51-46" className={styles.data}>+7 (929) 500-51-46</a>, &nbsp;
                         <a href="tel:+7(968)001-88-80" className={styles.data}>+7 (968) 001-88-80</a></p>
                        <p className={styles.data}>Почта: <a href="mailto:Mariolewool@yandex.ru" className={styles.data}>Mariolewool@yandex.ru</a></p>
